...
module.exports =  (client, message, args) => {
  ...
  if(!args[0]) return message.channel.send("Opciones: `piedra`, `papel` o `tijeras`").then(m => m.delete({timeout: 10000})) //El .then() es opcional, yo siempre lo agrego porque me gusta.
  ...
  if(args[0] == "piedra") {
    ...
    let random1 = ["He ganado! Elegi papel. El papel cubre a la roca.", // Perdedor -jeje-
                   "Has ganado! Elegi tijera. Las tijeras no pueden cortar rocas :sob:.",  // Ganaste :D
    ...
    let random2 = ["He ganado! Elegi tijera. Las tijeras cortan el papel.", // Perdedor -jeje-
                   "Has ganado! Elegi piedra. El papel cubre a la roca :sob:.",  // Ganaste :D
                   "Empate."] // Empate ._.

    message.reply(" "+random2[Math.floor(Math.random() * random2.length)]+"")
    
  } else if(args[0] == "tijeras") {

    let random3 = ["He ganado! Elegi piedra. Las rocas rompen las tijeras", // Perdedor -jeje-
                   "Has ganado! Elegi papel. Las tijeras cortan el papel :sob:.",  // Ganaste :D
                   "Empate."] // Empate ._.
